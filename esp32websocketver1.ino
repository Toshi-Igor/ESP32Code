...
const char* ssid = "HUAWEI-2.4G-q9gJ";
const char* password = "tTVFs6C8";

// WebSocket server settings
const char* websocket_host = "192.168.100.163";
...
const long interval = 60000;  // Send data every 5 seconds
